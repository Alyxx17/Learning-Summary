# ============================================================
# PPO 测试代码 —— 加载训练好的 actor-critic 网络并播放动画
# 只用 actor 头（logits）做决策，测试用 argmax（贪婪，表现更稳定）
# 与 A2C_test.py 结构完全一致，仅模型文件名不同
# ============================================================
...
LOAD_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ppo_lunarlander.pth")
# weights_only=False：文件是本机训练生成的（可信来源），兼容含 numpy 标量的旧模型文件
