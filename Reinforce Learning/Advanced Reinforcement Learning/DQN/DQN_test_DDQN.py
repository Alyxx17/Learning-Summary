# ============================================================
# Double DQN (DDQN) 测试代码
# 与基准 DQN_test.py 的唯一区别：加载 ddqn 模型文件
# （DDQN 只改训练时的目标值计算，推理逻辑与基准完全一致）
# ============================================================
...
q_net = q_net.to(DEVICE)  # 把网络也移到 DEVICE（和输入保持同一设备）
q_net.load_state_dict(torch.load("dqn_cartpole_ddqn.pth"))
