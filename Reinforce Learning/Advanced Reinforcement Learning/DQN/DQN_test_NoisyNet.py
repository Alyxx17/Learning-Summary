# ============================================================
# Noisy Net DQN 测试代码
# 网络结构与训练一致（Dueling + Noisy）；q_net.eval() 后 NoisyLinear 只用均值 μ，
# 推理是确定性的，不采样噪声
# ============================================================
...
class NoisyLinear(nn.Module):
    """带可学习噪声的线性层；eval() 模式下只用均值 μ，确定性输出"""
...
q_net.load_state_dict(torch.load("dqn_LunarLander_noisynet.pth"))
q_net.eval()   # 关键：切到评估模式，NoisyLinear 不再采样噪声
